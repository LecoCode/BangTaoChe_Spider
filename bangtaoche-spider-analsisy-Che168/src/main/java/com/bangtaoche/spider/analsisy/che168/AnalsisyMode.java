package com.bangtaoche.spider.analsisy.che168;

import com.bangtaoche.spider.analsisy.service.absAnalsisyMode;
 ...
 * @Function:
 */
public class AnalsisyMode extends absAnalsisyMode {
    private String pagexml;
    public AnalsisyMode setPageXMl(String pagexml){
    ...
    public List<CheBean> run() {
        ...
        if (elementById.getElementsByClass("list-photo").size()>0) {
            ...
            for (Element el:
                ...
                cheBean.setShangPaiShiJian(ShiFouShangXIng);
